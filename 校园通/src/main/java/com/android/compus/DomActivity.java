 ...
 *  ===============================
 */
public class DomActivity extends BaseActivity implements OnClickListener {
	...
	private String url = "http://222.195.240.186:8000/system/wuye/applyout.aspx";      //学校教务处网址。。。。tomcat
