...
import com.android.compus.adapter.NotepadAdapter;
import com.android.compus.bean.Notepad;
import com.android.compus.utils.SqliteHelper;
/** 
 * ===============================
 * 作者: 静静茹她: 
 * 创建时间：2015年8月18日 上午10:35:30 
 * 版本号： 1.0 
 * 版权所有(C) 2015年8月18日
 * 描述： 
 *  ===============================
 */
public class MyNoteMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.topButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(MyNoteMainActivity.this,
						WriteNoteActivity.class);
	...
	class ItemClick implements AdapterView.OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> paramAdapterView,
			...
			Map<String, Object> localMap = MyNoteMainActivity.this.itemList
					.get(paramInt);
			...
			MyNoteMainActivity.this.adapter.notifyDataSetChanged();
		}
